    ...
    class Coordinator: NSObject, NSTextViewDelegate {
        ...
        private func scheduleSyntaxHighlighting() {
            ...
            let workItem = DispatchWorkItem { [weak self] in
                ...
                self.textView?.enclosingScrollView?.verticalRulerView?.needsDisplay = true
            }
            syntaxHighlightWorkItem = workItem
            // Defer highlighting until after the paste/edit transaction has settled.
